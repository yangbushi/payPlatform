...
public class AlipaySubmit {
	...
	public static String buildRequestMysign(String sPara) {
    	String mysign = "";
        if(AlipayConfig.sign_type.equals("MD5") ) {
        	mysign = MD5.sign(sPara, AlipayConfig.key, AlipayConfig.input_charset);
        }
        if(AlipayConfig.sign_type.equals("0001") ){
        	mysign = RSA.sign(sPara, AlipayConfig.private_key, AlipayConfig.input_charset);
        }
        return mysign;
    }
	public static void main(String[] args) {
		//System.out.println(buildRequestMysign("cyf"));
		System.out.println(RSA.verify("cyf", buildRequestMysign("cyf"), AlipayConfig.ali_public_key, AlipayConfig.input_charset));
	}
    /**
     * 生成要请求给支付宝的参数数组
     ...
     * @return 签名结果字符串
     */
	public static String buildRequestMysign_refund(Map<String, String> sPara) {
    	String prestr = AlipayCore.createLinkString(sPara); //把数组所有元素，按照“参数=参数值”的模式用“&”字符拼接成字符串
        String mysign = "";
     ...
     * @return 要请求的参数数组
     */
    private static Map<String, String> buildRequestPara_refund(Map<String, String> sParaTemp) {
        //除去数组中的空值和签名参数
        Map<String, String> sPara = AlipayCore.paraFilter(sParaTemp);
        //生成签名结果
        String mysign = buildRequestMysign_refund(sPara);
    ...
    public static String buildRequest(Map<String, String> sParaTemp, String strMethod, String strButtonName) {
        //待请求参数数组
        Map<String, String> sPara = buildRequestPara_refund(sParaTemp);
        List<String> keys = new ArrayList<String>(sPara.keySet());
    ...
    public static String buildRequest_chinaBank(String strParaFileName, String strFilePath,Map<String, String> sParaTemp) throws Exception {
        //待请求参数数组
        ...
        request.setParameters(generatNameValuePair(sPara));
        request.setUrl("http://180.168.146.79/PGWPortal/RefundOrder.do");
     ...
     * @throws MalformedURLException
     */
	public static String query_timestamp_refund() throws MalformedURLException,
                                                        DocumentException, IOException {
