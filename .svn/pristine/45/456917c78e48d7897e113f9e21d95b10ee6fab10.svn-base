...
public class AlipayNotify {
    ...
    public static boolean verifyReturn(Map<String, String> params) {
	    ...
	    //验证签名
	    boolean isSign = getSignVeryfy_pay(params, sign, true);
    ...
    public static boolean verifyNotify(Map<String, String> params) throws Exception {
	    ...
	    String sign = "";
	    if(params.get("sign") != null) {sign = params.get("sign");}
	    boolean isSign = getSignVeryfy_pay(params, sign,false);
     ...
     * @return 生成的签名结果
     */
	private static boolean getSignVeryfy_pay(Map<String, String> Params, String sign, boolean isSort) {
     ...
     * @return 生成的签名结果
     */
	private static boolean getSignVeryfy_refund(Map<String, String> Params, String sign) {
    	//过滤空值、sign与sign_type参数
    	Map<String, String> sParaNew = AlipayCore.paraFilter(Params);
        //获取待签名字符串
